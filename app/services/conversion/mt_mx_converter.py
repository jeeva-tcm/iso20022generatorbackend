...
class MT2MXConverter:
    ...
    def _sort_xml_recursively(self, element: ET.Element, target_mx: str = ""):
        ...
        sequences = {
            ...
            "CdtTrfTxInf": [
                ...
                "InstgRmbrsmntAgt", "InstgRmbrsmntAgtAcct", "InstdRmbrsmntAgt", "InstdRmbrsmntAgtAcct", "ThrdRmbrsmntAgt", "ThrdRmbrsmntAgtAcct", "EqvtAmt",
                ...
                "Tax", "UndrlygCstmrCdtTrf", "UndrlygFICdtTrf", "RltdRmtInf", "RmtInf", "SplmtryData"
            ],
    ...
    def _heal_pacs009_mandatory_fields(self, root, namespaces):
        ...
        If the MT202COV lacks 53A/54A, we inject a dummy InstgRmbrsmntAgt to satisfy L3.
        """
        xmlns = namespaces.get("xmlns", "")
        ...
        sttlm_mtd = self._find_child(sttlm_inf, "SttlmMtd")
        if True:  # Disable dummy injection
            return
            
        instg_rmbr = self._find_child(sttlm_inf, "InstgRmbrsmntAgt")
        instd_rmbr = self._find_child(sttlm_inf, "InstdRmbrsmntAgt")
        
        if instg_rmbr is None and instd_rmbr is None:
            # Inject InstgRmbrsmntAgt into SttlmInf
            tag_prefix = f"{{{xmlns}}}" if xmlns else ""
            instg_rmbr = ET.SubElement(sttlm_inf, f"{tag_prefix}InstgRmbrsmntAgt")
            finstn_id = ET.SubElement(instg_rmbr, f"{tag_prefix}FinInstnId")
            othr = ET.SubElement(finstn_id, f"{tag_prefix}Othr")
            id_el = ET.SubElement(othr, f"{tag_prefix}Id")
            id_el.text = "NOTPROVIDED"
